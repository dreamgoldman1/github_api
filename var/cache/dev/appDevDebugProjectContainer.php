...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xK2pgWSxFc', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('c3Cb507E3a', 0, 'vytlPV1+4YlSO+EJhds8G8', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'github', 'user' => 'root', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/GOL/RepositoriesBundle/Resources/config/doctrine') => 'GOL\\RepositoriesBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'GOL\\RepositoriesBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('GOLRepositoriesBundle' => 'GOL\\RepositoriesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_55e8355c0c2f321c935d5b4db63446e9b9c4bfc4af16036560ae924d3f3f61a8');
     ...
     */
    protected function getGolApiService()
    {
        return $this->services['gol_api'] = new \GOL\ApiBundle\Controller\ApiController();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/GOL/RepositoriesBundle/Resources/views'), 'GOLRepositories');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b061446428d0687f33d8aecb30e8170304d2dbda');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('63R2Cgwgmb', 0, 'vytlPV1+4YlSO+EJhds8G8', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58e544539ec529.52038891')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GOLRepositoriesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GOL/RepositoriesBundle'),
                    'namespace' => 'GOL\\RepositoriesBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GOLRepositoriesBundle' => 'GOL\\RepositoriesBundle\\GOLRepositoriesBundle',
            ...
            'secret' => 'b061446428d0687f33d8aecb30e8170304d2dbda',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'b061446428d0687f33d8aecb30e8170304d2dbda',
